    ...
    <script>
            ...
            if (templateOpt) {
                ...
                $.ajax({
                    ...
                    'success': function (data) {
                        ...
                        if (typeof templateItem[tplId] == "undefined")
                            layer.confirm('模板已被删除', {icon: 2, title: '错误'}, function (index) {
                                delTemplate({!! $edit->model->id !!});
                                layer.close(index);
                            });
        ...
        function delTemplate(id) {
            $.ajax({
                ...
                'success': function (data) {
                    window.location.href='/official_account';
                },
                'error': function (obj, message) {
                    console.log(message);
                }
