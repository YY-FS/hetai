...
//
        ...
        $grid->button('推送APP通知', 'TR', ['class' => 'btn btn-warning', 'onclick' => $push]);
...
//            结束时间
    ...
    public function push()
    {
        ...
        $edit->label('测试APP通知');
        $edit->add('uid', '*uid', 'text')->placeholder('可输入多个uid,用“,”号隔开,群发则需输入“0000”')->insertValue(Cookie::get('uid', null));
        $edit->add('banner_id', 'banner_id', 'number')->placeholder('暂时可以先不用填')->insertValue(Cookie::get('banner_id', null));
